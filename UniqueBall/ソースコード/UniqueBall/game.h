...
public:
	...
	CCameraGame *GetCamera(int nIdx) { return m_ppCamera[nIdx]; }					//分割カメラの1つを取得
	CCameraGame **GetCamera() { return m_ppCamera; }								//分割カメラの取得
...
private:
	...
	CCameraGame *m_ppCamera[mylib_const::MAX_PLAYER];		//プレイヤー追従カメラ
};
