...
// 静的メンバ変数宣言
//*****************************************************************************
IXAudio2 *CSound::m_pXAudio2 = nullptr;								// XAudio2オブジェクトへのインターフェイス
IXAudio2MasteringVoice *CSound::m_pMasteringVoice = nullptr;		// マスターボイス
...
SOUNDINFO g_aSoundInfo[CSound::SOUND_LABEL_MAX] =
{
	...
	{ "data/BGM/game.wav", -1 },							// BGM1(仮)
	{ "data/BGM/game.wav", -1 },							// BGM2
	{ "data/BGM/result.wav", -1 },							// BGM3
	...
	{ "data/SE/countdown.wav", 0 },							// SE8
	{ "data/SE/go.wav", 0 },								// SE9
};
