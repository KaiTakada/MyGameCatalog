...
public:
	...
	void SetTarget(CObjectCharacter* pTarget) { m_pTarget = pTarget; }		//ターゲット設定
	CObjectCharacter* GetTarget(void) { return m_pTarget; }					//ターゲット取得
...
private:
	...
	CObjectCharacter *m_pTarget;		//ターゲット
